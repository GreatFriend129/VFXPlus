...
namespace VFXPlus.Content.Dusts
{
	...
	{
		public override string Texture => "VFXPlus/Content/Dusts/Textures/GlorbStrong";
	...
	{
		public override string Texture => "VFXPlus/Assets/Pixel/CrispStarPMA";
		private Texture2D circleGlow;


		public override void Load() => circleGlow = (Texture2D)ModContent.Request<Texture2D>("VFXPlus/Assets/Pixel/PartiGlowPMA");
		...
		public override bool PreDraw(Dust dust)
		{
			...
			if (dust.customData != null)
			{
				if (dust.customData is GlowStarSharpBehavior behavior)
				{
                    ...
                    {
						//TODO not this
						Texture2D Core = (Texture2D)ModContent.Request<Texture2D>("VFXPlus/Assets/Pixel/PartiGlowPMA");
