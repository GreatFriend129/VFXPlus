...
{
    public class GoozmaPrismStudy : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 myHome = Main.player[Projectile.owner].Center + new Vector2(250 * (float)Math.Sqrt(Utils.GetLerpValue(-65, -40, Time, true)), 0).RotatedBy(Spin + MathHelper.TwoPi / count * WhoAmI);
        ...
        {
            Texture2D texture = Mod.Assets.Request<Texture2D>("Content/VFXTest/PrismDestroyer").Value;
            Texture2D tellTexture = Mod.Assets.Request<Texture2D>("Assets/Pixel/Extra_89").Value;
            Texture2D bloom = Mod.Assets.Request<Texture2D>("Content/VFXTest/GoozmaGlowSoft").Value;
            //Texture2D bloom = Mod.Assets.Request<Texture2D>("Assets/Pixel/feather").Value;
            ...
            ModContent.GetInstance<PixelationSystem>().QueueRenderAction("UnderProjectiles", () =>
            {
                ...
                for (int i = 0; i < Rays; i++)
                {
                    ...
                    Main.EntitySpriteDraw(bloom, Projectile.Center - Main.screenPosition, null, rainbow * 0.6f, rotation, bloom.Size() * new Vector2(0.25f, 0.5f), attackScale * new Vector2(8f, 2f), 0, 0);
                }
