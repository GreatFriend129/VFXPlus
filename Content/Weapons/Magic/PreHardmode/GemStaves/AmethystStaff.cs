...
namespace VFXPlus.Content.Weapons.Magic.PreHardmode.MagicGuns
{
    ...
    public class AmethystStaffOverride : GlobalItem 
    {

        public override bool AppliesToEntity(Item item, bool lateInstatiation)
        {
            return lateInstatiation && (item.type == ItemID.AmethystStaff) && ModContent.GetInstance<VFXPlusToggles>().MagicToggle.AmethystStaffToggle;
        }
    ...
    public class AmethystStaffShotOverride : GlobalProjectile
    {
        public override bool InstancePerEntity => true;
        public override bool AppliesToEntity(Projectile entity, bool lateInstantiation)
        {
            return lateInstantiation && (entity.type == ProjectileID.AmethystBolt) && ModContent.GetInstance<VFXPlusToggles>().MagicToggle.AmethystStaffToggle;
        }
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            {
                int d = Dust.NewDust(projectile.position, 7, 7, ModContent.DustType<GlowPixelCross>(), newColor: Color.Purple * 1f, Scale: Main.rand.NextFloat(0.3f, 0.35f));
            ...
            Lighting.AddLight(projectile.Center, Color.Purple.ToVector3() * 1.15f * fadeInAlpha);
        ...
        public override bool PreDraw(Projectile projectile, ref Color lightColor)
        {
            ...
            Texture2D fireball = Mod.Assets.Request<Texture2D>("Content/Weapons/Magic/PreHardmode/GemStaves/Fireballs/AmethystFireball").Value;
            ...
            Main.EntitySpriteDraw(star, starDrawPos, null, Color.Purple with { A = 0 } * starSpinInPower, starRotation, star.Size() / 2f, starScale, se);
        ...
        public void NewTrail(Projectile projectile, bool returnImmediately)
        {
            ...
            float orbAlpha = 1.5f * fadeInAlpha;
            ...
            for (int i = 0; i < previousPositions.Count - 1; i++)
            {
                ...
                Vector2 vec2ScaleTrail = new Vector2(scale * 1f * Easings.easeOutSine(fadeInAlpha), Easings.easeInQuad(scale) * 0.6f) * projectile.scale;
                ...
                Color col = Color.Lerp(purple, betweenPurp, scale) * scale * fadeInAlpha;

                Main.spriteBatch.Draw(Spike, drawPosAI, null, col with { A = 0 } * 1f, previousRotations[i], Spike.Size() / 2f, vec2ScaleTrail, SpriteEffects.None, 0f);
            }
        }

        public override bool PreKill(Projectile projectile, int timeLeft)
        {
            Color purple = new Color(61, 2, 92) * 1.15f;
            Color darkPurple = new Color(42, 2, 82);
            Color purple3 = new Color(121, 7, 179);
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                Dust dust = Dust.NewDustPerfect(projectile.Center, ModContent.DustType<GlowPixelCross>(), randomStart, newColor: Color.Purple, Scale: Main.rand.NextFloat(0.45f, 0.7f));
            ...
            for (int i = 0; i < 4; i++)
            {
                Color col = Main.rand.NextBool(2) ? Color.Purple : purple3;
            ...
            Dust d1 = Dust.NewDustPerfect(projectile.Center, ModContent.DustType<FeatheredGlowDust>(), Velocity: Vector2.Zero, newColor: purple, Scale: 1f);
