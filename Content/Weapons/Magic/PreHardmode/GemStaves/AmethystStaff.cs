...
namespace VFXPlus.Content.Weapons.Magic.PreHardmode.MagicGuns
{
    ...
    public class AmethystStaffShotOverride : GlobalProjectile, IDrawAdditive
    {
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            trail1.trailColor = Color.Purple * fadeInAlpha * 0.7f; //10 155 10
            ...
            {
                int d = Dust.NewDust(projectile.position, 7, 7, ModContent.DustType<PixelGlowOrb>(), newColor: Color.Purple, Scale: Main.rand.NextFloat(0.35f, 0.4f));
            ...
            Lighting.AddLight(projectile.Center, Color.Purple.ToVector3() * 0.9f * fadeInAlpha);
        ...
        public override bool PreDraw(Projectile projectile, ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(glorb, drawPos, null, Color.Purple with { A = 0 } * fadeInAlpha * 0.5f, projectile.rotation, glorb.Size() / 2, new Vector2(projectile.scale, projectile.scale * 0.5f) * 1f, SpriteEffects.None);
            ...
            Main.EntitySpriteDraw(star, starDrawPos, null, Color.Purple with { A = 0 } * fadeInAlpha, starRotation, star.Size() / 2f, starScale, se);
        ...
        public override bool PreKill(Projectile projectile, int timeLeft)
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                Dust dust = Dust.NewDustPerfect(projectile.Center, ModContent.DustType<GlowPixelCross>(), randomStart, newColor: Color.Purple, Scale: Main.rand.NextFloat(0.45f, 0.75f));
            ...
            for (int i = 0; i < 7; i++)
            {
                Color col = Main.rand.NextBool(2) ? Color.Purple : Color.MediumPurple;
            ...
            //Light Dust
            Dust softGlow = Dust.NewDustPerfect(projectile.Center, ModContent.DustType<SoftGlowDust>(), Vector2.Zero, newColor: Color.Purple, Scale: 0.2f);
