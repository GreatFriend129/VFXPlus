...
namespace VFXPlus.Content.Weapons.Magic.PreHardmode.MagicGuns
{
    ...
    public class DiamondStaffShotOverride : GlobalProjectile
    {
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            trail1.trailColor = Color.White * fadeInAlpha * 0.7f;
            ...
            //Train2 info dump
            trail2.trailTexture = ModContent.Request<Texture2D>("VFXPlus/Assets/Trails/FlameTrail").Value;
            trail2.trailColor = FetchRainbow() * fadeInAlpha * 0.7f; 
            trail2.trailPointLimit = 15;
            trail2.trailWidth = (int)(15f * projectile.scale);
        ...
        public override bool PreKill(Projectile projectile, int timeLeft)
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                Dust dust = Dust.NewDustPerfect(projectile.Center, ModContent.DustType<GlowPixelCross>(), randomStart, newColor: FetchRainbow(), Scale: Main.rand.NextFloat(0.45f, 0.75f));
