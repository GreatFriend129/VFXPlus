...
namespace VFXPlus.Content.Weapons.Magic.PreHardmode.Staves
{
    ...
    public class ThunderZapper : GlobalItem 
    {
        ...
        {
            return lateInstatiation && (item.type == ItemID.ThunderStaff) && ModContent.GetInstance<VFXPlusToggles>().MagicToggle.ThunderZapperToggle;
        }
    ...
    public class ThunderStaffShotOverride : GlobalProjectile
    {
        ...
        public void Draw(Projectile projectile, bool giveUp)
        {
            ...
            //Orb
            Texture2D Glow = CommonTextures.GlowCircleFlare.Value;
            ...
            Main.spriteBatch.Draw(Core2, projectile.Center - Main.screenPosition, null, thisCol with { A = 0 }, rot, Core2.Size() / 2, scale * projectile.scale * 0.6f * 0.75f, SpriteEffects.None, 0f);
        }
