...
namespace VFXPlus.Content.Weapons.Ranged.Ammo.Bullets
{
    ...
    public class NanoBulletProjOverride : GlobalProjectile, IDrawAdditive
    {
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            trail1.trailColor = col * totalAlpha * 0.75f;
        ...
        public override bool PreDraw(Projectile projectile, ref Color lightColor)
        {
            ...
            Color spikeCol = Color.DodgerBlue;
            ...
            Color orbCol = Color.DeepSkyBlue;
            Vector2 orbScale = new Vector2(1f * easedJustHitPower, 0.3f * totalScale) * 0.7f * adjustedScale;
