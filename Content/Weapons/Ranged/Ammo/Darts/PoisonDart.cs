...
{
    public class PoisonDartOverride : GlobalProjectile
    {
        public override bool InstancePerEntity => true;

        public override bool AppliesToEntity(Projectile entity, bool lateInstantiation)
        {
            return lateInstantiation && (entity.type == ProjectileID.PoisonDartBlowgun);
        }
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            if ((timer + dustRandomOffsetTime) % 5 == 0 && Main.rand.NextBool(4) && timer > 5)
            {
                ...
                Dust dp = Dust.NewDustPerfect(pos, ModContent.DustType<MuraLineDust>(), vel * 0.8f, newColor: Color.DarkRed * 1f, Scale: Main.rand.NextFloat(0.3f, 0.65f) * 0.5f);
                dp.alpha = 12;
