...
{
    public class TacticalShotgun : GlobalItem 
    {
        public override bool InstancePerEntity => true;
        public override bool AppliesToEntity(Item item, bool lateInstatiation)
        {
            return lateInstatiation && (item.type == ItemID.TacticalShotgun);
        }
        ...
        public override bool Shoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                held.SetProjInfo(
                    GunID: ItemID.TacticalShotgun,
                    AnimTime: 24,
                    NormalXOffset: 18f,
                    DestXOffset: -1f, //-4
                    YRecoilAmount: 0.45f,
                    HoldOffset: new Vector2(0f, 2f),
                    TipPos: new Vector2(32f, -5f),
                    StarPos: new Vector2(25f, -5f)
                    );
