...
namespace VFXPlus.Content.Weapons.Ranged.PreHardmode.Bows
{
    ...
    public class HellwingBow : GlobalItem 
    {
        ...
        {
            return lateInstatiation && (item.type == ItemID.HellwingBow);
        }
    ...
    public class HellwingBatOverride : GlobalProjectile
    {
        ...
        public override bool PreDraw(Projectile projectile, ref Color lightColor)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Main.EntitySpriteDraw(vanillaTex, offset + drawPos + projectile.rotation.ToRotationVector2().RotatedBy((float)Math.PI / 2f * (float)i) * 2f, sourceRectangle, Color.Yellow with { A = 0 } * 2f, rot, TexOrigin,
        ...
        public void DrawVertexTrail(bool giveUp)
        {
            ...
            //Over layer
            Color col = Color.Lerp(Color.Orange, Color.OrangeRed, 1f);
