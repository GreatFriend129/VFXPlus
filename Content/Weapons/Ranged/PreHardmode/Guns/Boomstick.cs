...
namespace VFXPlus.Content.Weapons.Ranged.PreHardmode.Guns
{
    public class Boomstick : GlobalItem
    {
        ...
        {
            return lateInstatiation && (item.type == ItemID.Boomstick);
        }
        ...
        {
            SoundStyle style = new SoundStyle("VFXPlus/Sounds/Effects/Gun/BoomstickWithClick") with { Volume = 0.5f, Pitch = 0.0f, PitchVariance = 0.1f, MaxInstances = 1 };
            SoundEngine.PlaySound(style, position);
            //SoundStyle style = new SoundStyle("VFXPlus/Sounds/Effects/Gun/BoomstickFasterClick2") with { Volume = 0.5f, Pitch = 0.0f, PitchVariance = 0.1f, MaxInstances = 1 };
            //SoundEngine.PlaySound(style, position);

            //SoundStyle style = new SoundStyle("VFXPlus/Sounds/Effects/Gun/BoomstickWithClick") with { Volume = 0.5f, Pitch = 0.0f, PitchVariance = 0.1f * 0f, MaxInstances = 1 };
            //SoundEngine.PlaySound(style, position);
