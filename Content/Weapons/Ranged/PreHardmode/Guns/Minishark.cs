...
namespace VFXPlus.Content.Weapons.Ranged.PreHardmode.Guns
{
    public class Minishark : GlobalItem
    {
        ...
        {
            float volumeMult = 0.6f;

            SoundStyle style = new SoundStyle("VFXPlus/Sounds/Effects/Gun/GunShotC") with { Volume = 0.35f * volumeMult, Pitch = 0.2f, PitchVariance = 0.2f, MaxInstances = -1 };
            SoundEngine.PlaySound(style, player.Center);

            SoundStyle style2 = new SoundStyle("VFXPlus/Sounds/Effects/Gun/SingleShot") with { Volume = 0.5f * volumeMult, Pitch = -0.05f, PitchVariance = 0.3f, MaxInstances = -1 };
