...
namespace VFXPlus.Content.Weapons.Ranged.PreHardmode.Guns
{
    public class QuadBarrelShotgun : GlobalItem
    {
        ...
        {
            return lateInstatiation && (item.type == ItemID.QuadBarrelShotgun);
        }
        ...
        {
            SoundStyle style = new SoundStyle("VFXPlus/Sounds/Effects/Gun/BoomstickWithClick") with { Volume = 0.6f, Pitch = 0.0f, PitchVariance = 0.1f, MaxInstances = 1 };
            ...
            {
                held.SetProjInfo(
                    GunID: ItemID.QuadBarrelShotgun,
                    AnimTime: 26,
                    NormalXOffset: 18f,
                    DestXOffset: -6f,
                    YRecoilAmount: 0.5f,
                    HoldOffset: new Vector2(0f, 0f),
                    TipPos: new Vector2(31f, 0f),
                    StarPos: new Vector2(25f, 0f)
                    );
